        ...
        {dataFromServer && (
          <Grid container sx={{ pb: 4, pt: 4 }}>
            ...
            >
                  ...
                  <Fragment key={img.url}>
                    <Box
                      ...
                      sx={{
                        background:
                          index == imageIndex
                            ? `url(${img.url}), white 50%`
                            : `linear-gradient(0deg, rgba(255, 255, 255, 0.28) 0%, rgba(255, 255, 255, 0.28) 100%), url(${img.url}), white 50% / cover no-repeat`,
              ...
              <Box
                sx={{
                  background: `url(${mainImage}), white 50%`,
                  backgroundRepeat: "no-repeat",
                  m: "0 auto",
                  backgroundPosition: "center",
                  backgroundSize: "contain",
